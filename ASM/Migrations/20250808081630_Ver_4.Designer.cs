...
namespace ASM.Migrations
{
    ...
    [Migration("20250808081630_Ver_4")]
    partial class Ver_4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASM.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductID = 1,
                            CategoryID = 1,
                            CreatedAt = new DateTime(2025, 8, 8, 15, 16, 25, 855, DateTimeKind.Local).AddTicks(9385),
                        ...
                        new
                        {
                            ProductID = 2,
                            CategoryID = 2,
                            CreatedAt = new DateTime(2025, 8, 8, 15, 16, 25, 855, DateTimeKind.Local).AddTicks(9391),
                        ...
                        new
                        {
                            ProductID = 3,
                            CategoryID = 3,
                            CreatedAt = new DateTime(2025, 8, 8, 15, 16, 25, 855, DateTimeKind.Local).AddTicks(9396),
            ...
            modelBuilder.Entity("ASM.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = -1,
                            Address = "123 Main St",
                            CreatedAt = new DateTime(2025, 8, 8, 15, 16, 26, 122, DateTimeKind.Local).AddTicks(3754),
                            Email = "admin@example.com",
                            FullName = "Admin",
                            IsActive = true,
                            PasswordHash = "$2a$11$uhoFmhgYXDLHUtLwY8HJiOELy3wZBeP4LdCyNWDUh2OoQnrKXXXmy",
                            Phone = "0909999999",
                            Role = "Admin"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 8, 15, 16, 26, 395, DateTimeKind.Local).AddTicks(3319),
                            Email = "a@gmail.com",
                            FullName = "Nguyễn Văn A",
                            IsActive = true,
                            PasswordHash = "$2a$11$89.4STyhlzjoM0p0m8OnOO7vsqoH7h0Fa8f4peRjYo9ig7Ol5/0du",
                            Phone = "0912345678",
                            Role = "Customer"
                        });
                });
