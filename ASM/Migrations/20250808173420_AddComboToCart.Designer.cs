...
namespace ASM.Migrations
{
    ...
    [Migration("20250808173420_AddComboToCart")]
    partial class AddComboToCart
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASM.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductID = 1,
                            CategoryID = 1,
                            CreatedAt = new DateTime(2025, 8, 9, 0, 34, 18, 133, DateTimeKind.Local).AddTicks(9376),
                        ...
                        new
                        {
                            ProductID = 2,
                            CategoryID = 2,
                            CreatedAt = new DateTime(2025, 8, 9, 0, 34, 18, 133, DateTimeKind.Local).AddTicks(9381),
                        ...
                        new
                        {
                            ProductID = 3,
                            CategoryID = 3,
                            CreatedAt = new DateTime(2025, 8, 9, 0, 34, 18, 133, DateTimeKind.Local).AddTicks(9386),
            ...
            modelBuilder.Entity("ASM.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = -1,
                            Address = "123 Main St",
                            CreatedAt = new DateTime(2025, 8, 9, 0, 34, 18, 404, DateTimeKind.Local).AddTicks(6922),
                            Email = "admin@example.com",
                            FullName = "Admin",
                            IsActive = true,
                            PasswordHash = "$2a$11$ofU4asvTiO.stsx8dFNto.HI4Bm6O5oL.Chl1KozHPNdxvkXfZMry",
                            Phone = "0909999999",
                            Role = "Admin"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 9, 0, 34, 18, 683, DateTimeKind.Local).AddTicks(944),
                            Email = "a@gmail.com",
                            FullName = "Nguyễn Văn A",
                            IsActive = true,
                            PasswordHash = "$2a$11$RoH/mFMRjaEPbExQOmJ8NuBx5cg8t2ZsEEbsqYByYcl.3E6Hh6Xz6",
                            Phone = "0912345678",
                            Role = "Customer"
                        });
                });
