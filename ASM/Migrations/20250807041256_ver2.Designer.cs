            ...
            modelBuilder.Entity("ASM.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductID = 1,
                            CategoryID = 1,
                            CreatedAt = new DateTime(2025, 8, 7, 11, 12, 52, 562, DateTimeKind.Local).AddTicks(2005),
                        ...
                        new
                        {
                            ProductID = 2,
                            CategoryID = 2,
                            CreatedAt = new DateTime(2025, 8, 7, 11, 12, 52, 562, DateTimeKind.Local).AddTicks(2011),
                        ...
                        new
                        {
                            ProductID = 3,
                            CategoryID = 3,
                            CreatedAt = new DateTime(2025, 8, 7, 11, 12, 52, 562, DateTimeKind.Local).AddTicks(2016),
            ...
            modelBuilder.Entity("ASM.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = -1,
                            Address = "123 Main St",
                            CreatedAt = new DateTime(2025, 8, 7, 11, 12, 52, 857, DateTimeKind.Local).AddTicks(9740),
                            Email = "admin@example.com",
                            FullName = "Admin",
                            IsActive = true,
                            PasswordHash = "$2a$11$UJ.np16B/mIpZwrrgEHuGOEGHa9nLkroz83QOC8qM8tX/EksmOmqK",
                            Phone = "0909999999",
                            Role = "Admin"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 7, 11, 12, 53, 137, DateTimeKind.Local).AddTicks(3541),
                            Email = "a@gmail.com",
                            FullName = "Nguyễn Văn A",
                            IsActive = true,
                            PasswordHash = "$2a$11$LM1jEvFO3aEVGVYSVDn.yuVszs6GS1s/usLkRGuQZSpqklfFujXZe",
                            Phone = "0912345678",
                            Role = "Customer"
                        });
                });
